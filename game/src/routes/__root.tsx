...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Iconic Games" },
      { name: "theme-color", content: "#070b18" },
      { property: "og:site_name", content: "Mīharo: The Showdown" },
      { property: "og:title", content: "Mīharo: The Showdown | Iconic Games" },
      {
        property: "og:description",
        content: "TV is the show, phones are the controllers. Up to six players, no downloads.",
      },
